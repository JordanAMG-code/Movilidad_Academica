...
Select UNIVERSIDAD.NombreU, UNIVERSIDAD.Pais, UNIVERSIDAD.Estado, 
FACULTAD.NombreF, 
CARRERA.NombreC, CARRERA.Tem_Carrera, 
MOVILIDAD.Ciclo_Escolar, MOVILIDAD.NombresCE,MOVILIDAD.P_ApellidoCE, MOVILIDAD.S_ApellidoCE, MOVILIDAD.Numero_ContactoEmergencia,
ESTUDIANTES.NombresE, ESTUDIANTES.P_ApellidoE, ESTUDIANTES.S_ApellidoE, ESTUDIANTES.Fecha_Nacimiento, ESTUDIANTES.Domicilio, ESTUDIANTES.Nacionalidad, ESTUDIANTES.Semestre, 
ESTUDIANTES.Num_telefono, 
GRUPOS.nombre_grupo 
